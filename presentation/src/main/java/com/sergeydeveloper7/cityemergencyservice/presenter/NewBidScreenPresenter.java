...
public class NewBidScreenPresenter implements BasePresenter {

    private Context                  context;
    private String                   tag;
    private BidsService              bidsService;
    private NewBidScreenView view;
    private Subscription             getActiveBidsSubscription;

    public NewBidScreenPresenter(Context context, String tag, NewBidScreenView view) {
    ...
    public void newBid(NewBidRequestModel newBidRequestModel){
        view.beforeRequest();
        getActiveBidsSubscription = bidsService.newBid(newBidRequestModel)
                ...
                .subscribe(response -> {
                    ...
                    if(response.isSuccessful() && response.body() != null){
                        ...
                        view.newBidResponse(response.body().isSuccess());
                    }
                }, throwable -> {
