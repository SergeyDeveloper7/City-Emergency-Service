...
public class AdminScreenPresenter implements BasePresenter {

    private Context                  context;
    private String                   tag;
    private BidsService              bidsService;
    private AdminScreenView          view;
    private Subscription             getActiveBidsSubscription;

    public AdminScreenPresenter(Context context, String tag, AdminScreenView view) {
        ...
        getActiveBidsSubscription = bidsService.getBids(status)
                ...
                .subscribe(response -> {
                    ...
                    if(response.isSuccessful() && response.body() != null){
                        ...
                        view.getBidsRequest(response.body().getBids());
                    }
                }, throwable -> {
